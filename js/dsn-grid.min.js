window.$build = {
    swiper: []
}, window.$wind = jQuery(window), window.$body = jQuery("body"), window.$controller = new ScrollMagic.Controller, window.$scene = [], gsap.config({
    autoSleep: 60,
    force3D: !1,
    nullTargetWarn: !1
}), gsap.defaults({
...
window.$dsnOption = {
    heightScroll: dsnGrid.getHeightScroll()
